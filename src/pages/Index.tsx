...
const Index = () => {
	...
	const completedQuestions = Object.values(progress).reduce(
		(acc, topicProgress) =>
			acc + Object.values(topicProgress || {}).filter(Boolean).length,
		0
	);
	...
	return (
		<div
			...
			<div className='min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark-grid-bg transition-all duration-500 relative'>
				{/* Header */}
				<header className='sticky top-0 z-50 backdrop-blur-xl bg-white/80 dark:bg-black/90 border-b border-gray-200/50 dark:border-gray-800/50 shadow-lg'>
						...
						<div className='flex items-center space-x-3 animate-fade-in'>
							...
							<div>
								...
								<p className='text-sm text-gray-600 dark:text-gray-400'>
									450+ Questions • Build Confidence
								</p>
							</div>
						</div>
				...
				<main className='container mx-auto px-4 py-8'>
					...
					<div className='text-center mb-12 animate-fade-in'>
						...
						<p className='text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed'>
							A comprehensive tracker with 450+ questions to build your confidence and
							ace your coding interviews
						</p>
					</div>

					{/* Enhanced Progress Overview */}
					<div className='mb-8 bg-white/70 dark:bg-black/80 backdrop-blur-xl rounded-2xl border border-gray-200/50 dark:border-gray-700/30 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.02] animate-scale-in'>
						<div className='p-8'>
					...
					<div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8'>
						<RandomQuestionPicker
							questions={filteredTopics.flatMap((topic) =>
								topic.questions.map((q) => ({ ...q, topic: topic.topicName }))
							)}
						/>

						<div className='bg-white/70 dark:bg-black/80 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/30 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:scale-[1.02] rounded-2xl'>
							<div className='p-6'>
								...
								<p className='text-gray-600 dark:text-gray-400 mb-6'>
									Access comprehensive notes and solutions
								</p>
								...
								<p className='text-sm text-gray-600 dark:text-gray-400 text-center'>
									Click the notes icon next to any question to access detailed
					...
					<div className='mb-8 animate-fade-in'>
						<div className='relative max-w-2xl mx-auto'>
							...
							<Input
								...
								className='pl-12 pr-4 py-4 text-lg bg-white/90 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/30 shadow-xl rounded-2xl focus:ring-4 focus:ring-blue-500/20 transition-all duration-300'
							/>
						</div>
					</div>
